...
function sortearMinas(matriz, quantidadeDeMinas) {
...
function contarTodasBombas(matriz) {
    let linhas = matriz.length;
    let colunas = matriz[0].length;
...
const campoMinado = criarMatriz(5, 5);
const gabaritoCampoMinado = JSON.parse(JSON.stringify(campoMinado)); // Deep copy
